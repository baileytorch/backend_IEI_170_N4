...
class Autor(models.Model):
    ...
    imagen_autor = models.URLField(null=True)
    created_at = models.DateTimeField(default=ahora)
    updated_at = models.DateTimeField(auto_now=True)
...
class Comuna(models.Model):
    codigo_comuna = models.CharField(max_length=5, null=False, unique=True)
...
class Lector(models.Model):
    ...
    fecha_nacimiento = models.DateField(
        null=True, default=None, validators=[validar_mayoria_edad])
    genero = models.CharField(max_length=1,choices=OpcionesGenero.choices,default=OpcionesGenero.MASCULINO)
    habilitado = models.BooleanField(default=True)
    created_at = models.DateTimeField(default=ahora)
    updated_at = models.DateTimeField(auto_now=True)
...
class TipoParametro(models.Model):
    tipo_parametro = models.CharField(max_length=50, null=False)
    habilitado = models.BooleanField(default=True)
    created_at = models.DateTimeField(default=ahora)
    updated_at = models.DateTimeField(auto_now=True)
...
class Parametro(models.Model):
    id_tipo_parametro = models.ForeignKey(
        TipoParametro, on_delete=models.CASCADE, null=False)
    clave_parametro = models.CharField(max_length=100, null=False)
    valor_parametro = models.CharField(max_length=255, null=True)
    habilitado = models.BooleanField(default=True)
    created_at = models.DateTimeField(default=ahora)
    updated_at = models.DateTimeField(auto_now=True)
